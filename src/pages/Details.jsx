...
function Details({ handleAddToCart }) {
  ...
  const defaultProduct = {
    name: 'Stylish Chair',
    price: 'IDR 1.500.000',
    description: 'A stylish chair made from quality wood and fabric, perfect for your living room.',
    image1: '/images/content/chair-1.png',
    image2: '/images/content/chair-2.png',
    image3: '/images/content/chair-3.png',
    image4: '/images/content/chair-4.png',
    // image5: '/images/content/chair-5.png',
  };
  const { name, price, description, image1, image2, image3, image4 } = location.state || defaultProduct;
